...
class CharacterSelectScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.rightCursor.addImage = (defaultImage) => {
      rightPlayerImage = this.add
        .image(this.config.width * 0.8, this.config.height * 0.7, defaultImage)
        .setFlipX(true);
  ...
  createCharacterIcon() {
    this.elmoIcon = new CharacterIcon(
      this,
    ...
    this.cookieIcon = new CharacterIcon(
      this,
      this.config.width / 2 + 100,
      this.config.height / 2 + 70,
      "cookieSelectionIcon",
